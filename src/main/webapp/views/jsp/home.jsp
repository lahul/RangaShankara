	...
	<div class="form search-form horizontal position-bottom inputs-dark">
		<div class="container">
			<form>
					...
					<div class="col-md-2 col-sm-4">
						<div class="form-group">
							<input type="text" class="form-control date-picker"
								name="min-price" placeholder="Event Date">
						</div>
						<!--end form-group-->
					</div>
					<!--end col-md-4-->
					<div class="col-md-1 col-sm-4">
						<div class="form-group">
							<button type="submit" data-ajax-response="map"
								...
								class="btn btn-primary pull-right darker">
				...
				<!--end row-->
				<h4 class="advanced-search-heading">
					<a href="#advanced-search-collapse" data-toggle="collapse"
						aria-expanded="false" aria-controls="advanced-search-collapse"
						class="font-color-white icon link">Advanced Search <i
						class="fa fa-plus"></i></a>
				</h4>
				<div class="row collapse" id="advanced-search-collapse">
					...
					<div class="col-md-2">
						<div class="ui-slider" id="price-slider" data-value-min="10"
							data-value-max="400" data-value-type="price" data-currency="$"
							data-currency-placement="before">
							<div class="values clearfix">
								<input class="value-min" name="value-min[]" readonly> <input
									class="value-max" name="value-max[]" readonly>
							</div>
	...
	<div class="container">
		<div class="center">
			<div class="section-title">
				<div class="center">
					<h2>Recent Places</h2>
					<h3 class="subtitle">Fusce eu mollis dui, varius convallis
						mauris. Nam dictum id</h3>
				</div>
			</div>
			<!--end section-title-->
		</div>
		...
		<div class="row">
				...
				<div class="item" data-id="1">
					...
					<div class="additional-info">
						<div class="rating-passive" data-rating="4">
							<span class="stars"></span> <span class="reviews">6</span>
						</div>
				...
				<div class="item" data-id="2">
					...
					<div class="additional-info">
						<div class="rating-passive" data-rating="3">
							<span class="stars"></span> <span class="reviews">13</span>
						</div>
						<div class="controls-more">
							<ul>
								<li><a href="#">Add to favorites</a></li>
			...
			<div class="col-md-6 col-sm-6">
				<div class="item" data-id="15">
					...
					<div class="additional-info">
						<figure class="circle" title="Featured">
							<i class="fa fa-check"></i>
						</figure>
						<div class="rating-passive" data-rating="5">
							<span class="stars"></span> <span class="reviews">56</span>
						</div>
						<div class="controls-more">
							<ul>
								<li><a href="#">Add to favorites</a></li>
			...
			<div class="col-md-4 col-sm-4">
				<div class="item" data-id="3">
					...
					<div class="additional-info">
						...
						<div class="rating-passive" data-rating="5">
							<span class="stars"></span> <span class="reviews">12</span>
						</div>
						<div class="controls-more">
							<ul>
								<li><a href="#">Add to favorites</a></li>
			...
			<div class="col-md-3 col-sm-3">
				<div class="item" data-id="4">
					...
					<div class="additional-info">
						<div class="rating-passive" data-rating="5">
							<span class="stars"></span> <span class="reviews">43</span>
						</div>
						<div class="controls-more">
							<ul>
								<li><a href="#">Add to favorites</a></li>
				...
				<div class="item" data-id="6">
					...
					<div class="additional-info">
						<div class="rating-passive" data-rating="0">
							<span class="stars"></span> <span class="reviews">0</span>
						</div>
						<div class="controls-more">
							<ul>
								<li><a href="#">Add to favorites</a></li>
		...
		<div class="center">
			<a href="listing.html"
				class="btn btn-primary btn-light-frame btn-rounded btn-framed arrow">View
				all listings</a>
		</div>
		<!--end center-->
	</div>
				...
				<div class="col-md-3 col-sm-3">
					<div class="list-item">
						...
						<ul>
							...
							<figure class="count">3
								</figure></li>
							<li><a href="">History</a>
							<figure class="count">2
								</figure></li>
							<li><a href="">Literature</a>
							<figure class="count">4
								</figure></li>
						</ul>
					</div>
					<!--end list-item-->
				...
				<div class="col-md-3 col-sm-3">
					<div class="list-item">
						...
						<ul>
							...
							<figure class="count">9
								</figure></li>
							<li><a href="">Music</a>
							<figure class="count">1
								</figure></li>
							<li><a href="">Humor </a>
							<figure class="count">4
								</figure></li>
...
<div class="block background-is-dark">
	<div class="container">
		<div class="section-title vertical-aligned-elements">
			...
			<div class="element text-align-right">
				<a href="#"
					class="btn btn-framed btn-rounded btn-default invisible-on-mobile">Promote
					yours</a>
	...
	<div class="gallery featured">
		<div class="owl-carousel" data-owl-items="6" data-owl-loop="1"
			data-owl-auto-width="1" data-owl-nav="1" data-owl-dots="1"
			data-owl-nav-container="#gallery-nav">
			...
			<div class="item featured" data-id="7">
				...
				<div class="additional-info">
					<div class="rating-passive" data-rating="5">
						<span class="stars"></span> <span class="reviews">17</span>
					</div>
					<div class="controls-more">
						<ul>
							<li><a href="#">Add to favorites</a></li>
		...
		<div class="row">
			<div class="col-md-4 col-sm-4">
				<div class="text-element event">
					...
					<figure class="date">
						<i class="icon_clock_alt"></i>08:00
					</figure>
			...
			<div class="col-md-4 col-sm-4">
				<div class="text-element event">
					<div class="date-icon">
						...
						<figure class="month">Jul
						</figure>
					</div>
					<h4>
						<a href="detail.html">Donec mattis mi vitae volutpat</a>
					</h4>
					<figure class="date">
						<i class="icon_clock_alt"></i>12:00
					</figure>
					<p>Nullam vitae ex ac neque viverra ullamcorper eu at nunc.
						Morbi imperdiet.</p>
					<a href="detail.html" class="link arrow">More</a>
				</div>
				<!--end text-element-->
			...
			<div class="col-md-4 col-sm-4">
				<div class="text-element event">
					<div class="date-icon">
						...
						<figure class="month">Aug
						</figure>
					</div>
					<h4>
						<a href="detail.html">Vivamus placerat</a>
					</h4>
					<figure class="date">
						<i class="icon_clock_alt"></i>12:00
					</figure>
					<p>Aenean sed purus ut massa scelerisque bibendum eget vel
						massa.</p>
					<a href="detail.html" class="link arrow">More</a>
				</div>
				<!--end text-element-->
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-3">
				...
				<div class="testimonials center box">
					<div class="owl-carousel" data-owl-items="1" data-owl-nav="0"
						data-owl-dots="1">
						<blockquote>
							<div class="image">
							...
							<p>Ut nec vulputate enim. Nulla faucibus convallis dui. Donec
								arcu enim, scelerisque gravida lacus vel.</p>
						</blockquote>
						<blockquote>
							<div class="image">
								<div class="bg-transfer">
							...
							<h3>Peter Doe</h3>
							<h4>CEO at ArtBrands</h4>
							<p>Donec arcu enim, scelerisque gravida lacus vel, dignissim
								cursus lectus. Aliquam laoreet purus in iaculis sodales.</p>
						</blockquote>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-4">
				<div class="text-element">
					...
					<figure class="date">21.06.2015
					</figure>
					<p>Ut nec vulputate enim. Nulla faucibus convallis dui. Donec
						arcu enim, scelerisque gravida lacus vel, dignissim cursus</p>
			...
			<div class="col-md-4 col-sm-4">
				<div class="text-element">
					<h4>
						<a href="blog-detail.html">Sed et justo ut nibh condimentum
							lacinia</a>
					</h4>
					<figure class="date">13.06.2015
					</figure>
					<p>Donec arcu enim, scelerisque gravida lacus vel, dignissim
						cursus lectus. Aliquam laoreet purus in iaculis sodales.</p>
					<a href="blog-detail.html"><i class="arrow_right"></i></a>
			...
			<div class="col-md-4 col-sm-4">
				<div class="text-element">
					<h4>
						<a href="blog-detail.html">Suspendisse varius eros id enim </a>
					</h4>
					<figure class="date">03.04.2015
					</figure>
					<p>Nullam nec turpis blandit, sodales risus vitae, tincidunt
						velit. Vestibulum ac ipsum tincidunt, vestibulum leo eget,</p>
					<a href="blog-detail.html"><i class="arrow_right"></i></a>
				</div>
				<!--end text-element-->
			</div>
