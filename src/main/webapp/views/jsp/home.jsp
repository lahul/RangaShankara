                ...
                <div class="container">
                    <form>
                        ...
                        <h4 class="advanced-search-heading">
                            <a href="#advanced-search-collapse" data-toggle="collapse" aria-expanded="false" aria-controls="advanced-search-collapse" class="font-color-white icon link">Advanced Search <i class="fa fa-plus"></i></a>
                        </h4>
